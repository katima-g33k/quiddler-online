		...
		<Panel>
			<details>
				...
				<ul className="mt-2 list-disc space-y-1 pl-4 text-sm text-stone-400">
					...
					<li>
						<strong>Going out</strong> means laying down words that use every
						card in your hand except one, which you discard.
					</li>
					<li>
					...
					<li>
						Words are at least 2 letters. A two-letter card counts as one card
						but two letters, so
						<em> IN</em> alone is a legal word and helps you win the
						longest-word bonus.
					</li>
					<li>
						Words are checked against dictionaryapi.dev. If a real word is
						missing there, add it to the house dictionary and play it.
					</li>
					<li>
